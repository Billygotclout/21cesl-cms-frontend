...
const PublishedServices = () => {
  ...
  const toggleSelectAll = () => {
    if (selectedServices.length === publishedServices.length) {
      setSelectedServices([]);
    } else {
      setSelectedServices(publishedServices.map((service) => service.id));
    }
  };
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-medium">Published services</h2>
              ...
              <tr className="border-b border-gray-100">
                <th className="px-6 py-3 text-left">
                  <input
                    type="checkbox"
                    className="w-4 h-4"
                    checked={selectedServices.length === publishedServices.length}
