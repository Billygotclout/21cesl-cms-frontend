...
const PublishedWebinars = () => {
  ...
  const toggleSelectAll = () => {
    if (selectedWebinars.length === publishedWebinars.length) {
      setSelectedWebinars([]);
    } else {
      setSelectedWebinars(publishedWebinars.map((webinar) => webinar.id));
    }
  };
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-medium">Published webinars</h2>
              ...
              <tr className="border-b border-gray-100">
                <th className="px-6 py-3 text-left">
                  <input
                    type="checkbox"
                    className="w-4 h-4"
                    checked={selectedWebinars.length === publishedWebinars.length}
...
export default PublishedWebinars;